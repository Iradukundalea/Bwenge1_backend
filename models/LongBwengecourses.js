...
const LongBwengeCourseSchema = mongoose.Schema({
  title: {
    type: String,
  ...
  price: {
    type: Number,
    required: [true, "Please provide course's price"],
  },
  lastUpdated: {
    type: Date,
...
const LongBwengeCourse = mongoose.model("LongBwengeCourse", LongBwengeCourseSchema);
export default LongBwengeCourse;
